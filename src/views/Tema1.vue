        ...
        .row.px-5       
          ...
          .col-sm-12.col-lg-4
            LineaTiempoE.color-acento-contenido
              .row
                .col-12
                  p.mb-0 #[b Audaces Idea:] para la creación de fichas técnicas y geometrales digitales.

              .row
                .col-12
                  p.mb-0 #[b Audaces 4D: ] desarrollo de elementos, prendas en 4D.
      
              .row
                .col-12
                  p.mb-0 #[b Audaces ISA:] gestión de colecciones, programador.
          
          .col-sm-12.col-lg-4
            LineaTiempoE.color-acento-contenido
              .row
                .col-12
                  p.mb-0 #[b Audaces Patrones:] desarrollo de patronaje y escalado de prendas.

              .row
                .col-12
                  p.mb-0 #[b Audaces Tizada:] desarrollo de trazo de moldes a partir del patronaje de prendas.
